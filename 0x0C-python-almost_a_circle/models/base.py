...
class Base:
    ...
    def save_to_file(cls, list_objs):
        '''
            A class method that that writes the JSON string representation of list_objs to a file:
            args:
    ...
    def from_json_string(json_string):
        '''
            A staticmethod that returns the list of JSON string representation of json_string
            arg: json_string
        '''
